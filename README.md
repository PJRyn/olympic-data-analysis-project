# Monash University Data Analytics bootcamp Capstone 1

This task was one of our large capstone projects for the Monash University Data Analytics bootcamp. We had to use webscraping to collect data and present it. In this project I was the team lead, doing the webscraping as well as the data visualisation. I have uploaded this project to my github for hosting purposes.
...
According to nbc sports, United States of America has always been on the top and has won the most medals in the history of Olympic games. After it is Russia, Germany, Great Britain and France. (See Reference 1)

In this report we had analysed some mesurable factors to see if they contribute to the success within the Olympic games. The two major factors we had considered in this report was the GDP as well as the population. Since these are metrics that can easily be seen and measured from each contry.


### Getting Started

This is a short guide to install the necessary libraries to run the notebooks for this project.
